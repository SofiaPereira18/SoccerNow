...
/**
 * Represents an UserDetailsDTO. Not an entity; used to return detailed user
 * information in the
 * verifyUser endpoint. It includes both common attributes and specific ones for
 * players and
 * referees.
 *
...
public class UserDetailsDTO {
  ...
  /**
   * Constructs a UserDetailsDTO with the provided details for either a player or
   * a referee.
   *
   ...
   * @param position       the position of the player on the field (only
   *                       applicable to players)
   * @param teams          the list of teams the player belongs to (only
   *                       applicable to players)
   * @param totalGoals     the total number of goals scored by the player (only
   *                       applicable to players)
   * @param totalCards     the total number of cards received by the player (only
   *                       applicable to players)
   * @param totalMatches   the total number of matches played or refereed by the
   *                       user
   * @param hasCertificate a flag indicating if the referee is certified (only
   *                       applicable to
   *                       referees)
   * @param refereeTeams   the list of teams the referee is assigned to (only
